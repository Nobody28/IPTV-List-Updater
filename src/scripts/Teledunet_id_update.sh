...
if [ -f /etc/enigma2/userbouquet.teledunet.tv ]
	then
	sed -i "s/id0=[0-9]\{13\}/id0="$id0/g /etc/enigma2/userbouquet.teledunet.tv
fi
if [ -f /etc/enigma2/userbouquet.ilu_teledunet.tv ]
	then
	sed -i "s/id0=[0-9]\{13\}/id0="$id0/g /etc/enigma2/userbouquet.ilu_teledunet.tv
fi
#
